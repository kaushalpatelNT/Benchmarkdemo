...
public class PendingComplaintAdapter extends RecyclerView.Adapter<PendingComplaintAdapter.CustomViewHolder> {
    ...
    public PendingComplaintAdapter(Context context, List<ResponseAssignedList.ComplaintData> listData) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_pending_complaint, null);
    ...
    public void onBindViewHolder(CustomViewHolder holder, final int position) {
        ...
        holder.tvCompanyName.setTypeface(mTypefacesemiBold);
        ...
        holder.llPending.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Constant.ACTIVITY_NAME, Constant.ActivityTitle.PENDING);
                ...
                intent.putExtra(Constant.Complaint.BillNo, listData.get(position).getBillNumber());
                intent.putExtra(Constant.Complaint.DealerName, listData.get(position).getDealerName());
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public CustomViewHolder(View view) {
            ...
            tvCustomerName = view.findViewById(R.id.tv_pending_name);
            tvCompanyName = view.findViewById(R.id.tv_pending_company_name);
            tvComplaintId = view.findViewById(R.id.tv_pending_id);
            tvComplaintDate = view.findViewById(R.id.tv_pending_date);
