...
public class RejectedComplaintAdapter extends RecyclerView.Adapter<RejectedComplaintAdapter.CustomViewHolder> {
    ...
    public RejectedComplaintAdapter(Context context, List<ResponseAssignedList.ComplaintData> listData) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_rejected_complaint, null);
    ...
    public void onBindViewHolder(CustomViewHolder holder, final int position) {
        ...
        holder.llRejected.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, ComplaintDetailsActivity.class);
                intent.putExtra(Constant.ACTIVITY_NAME, Constant.ActivityTitle.REJECTED);
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public CustomViewHolder(View view) {
            ...
            tvCustomerName = view.findViewById(R.id.tv_rejected_name);
            tvCompanyName = view.findViewById(R.id.tv_rejected_company_name);
            tvComplaintId = view.findViewById(R.id.tv_rejected_id);
            tvComplaintDate = view.findViewById(R.id.tv_rejected_date);
            llRejected = view.findViewById(R.id.ll_rejected);
        }
